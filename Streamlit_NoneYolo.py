    ...
    try:
        if results_yolo is not None:
            ...
            if results_pose.pose_landmarks is not None:
                ...
                left_elbow_angle_display.text(f"Left Angle: {left_elbow_angle:.2f}")
                right_elbow_angle_display.text(f"Right Angle: {right_elbow_angle:.2f}")
                left_hip_angle_display.text(f"Left Angle: {left_hip_angle:.2f}")
                right_hip_angle_display.text(f"Right Angle: {right_hip_angle:.2f}")
                left_knee_angle_display.text(f"Left Angle: {left_knee_angle:.2f}")
                right_knee_angle_display.text(f"Right Angle: {right_knee_angle:.2f}")
                left_ankle_angle_display.text(f"Left Angle: {left_ankle_angle:.2f}")
                right_ankle_angle_display.text(f"Right Angle: {right_ankle_angle:.2f}")
